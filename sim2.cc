...
int main(int argc, char *argv[]){
    ...
    ***********************************/
    ...
    OnOffHelper client (str("UdpSocketFactory"),InetSocketAddress(wifiRxInterface.GetAddress(0),udp_server_port)); //makes it easier to work with OnOffApplications. UdpSocketFactory is API to create UDP socket instances sending to addr specified.
