...
int main(int argc, char *argv[]){
    ...
    ***********************************/
    ...
    OnOffHelper client (StringValue("UdpSocketFactory"),Address("10.0.1.0")); //makes it easier to work with OnOffApplications. UdpSocketFactory is API to create UDP socket instances sending to addr specified.
